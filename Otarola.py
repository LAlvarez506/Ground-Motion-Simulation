...
class EQ(object):
    ...
    def __init__(self,geometry,Mw,parameters=None,wd=None,print_info=None):
        ...
        if 'quality_factor' in parameters:
            if parameters['quality_factor'] is not None:
                EQ.quality_factor = parameters['quality_factor']
        if 'quality_factor_lim' in parameters:
            if parameters['quality_factor_lim'] is not None:
                EQ.quality_factor_lim = parameters['quality_factor_lim']
